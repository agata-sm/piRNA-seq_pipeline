...
In the simplest case, all merged clusters can be used as the master file. It's generated by the pipeline for each dataset, and if several datasets are to be combined for cluster seletion, it can be generated by:
...
the value in the output is the **average of the selected clusters**
